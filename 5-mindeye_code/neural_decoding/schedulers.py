...
def get_scheduler(optimizer, scheduler_type, num_epochs, num_train, batch_size, num_devices, max_lr):
    """학습률 스케줄러 선택자"""
    ...
    if scheduler_type == 'cycle':
        return cycle_scheduler(optimizer, total_steps, max_lr, num_epochs)
